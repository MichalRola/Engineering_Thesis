...
# X_maro = []
# image = plt.imread(r"D:\Folders\_Engineering_ThesisV2\Maro\1(0).png")[:, :, 1]
# X_maro.append([image])
# image = plt.imread(r"D:\Folders\_Engineering_ThesisV2\Maro\1(1).png")[:, :, 1]
# X_maro.append([image])
# image = plt.imread(r"D:\Folders\_Engineering_ThesisV2\Maro\1(2).png")[:, :, 1]
# X_maro.append([image])
# y_maro = [3, 3, 3]
#
# X_maro = np.swapaxes(X_maro, 1, -1)
# X_maro = np.swapaxes(X_maro, 1, 2)
#
# y_prob = model.predict(X_maro)
# y_pred = np.argmax(y_prob, axis=1)
#
# y_test_decoded = coding.inverse_transform(y_maro)
# y_pred_decoded = coding.inverse_transform(y_pred)
